...
struct SettingsView: View {
    ...
    private func importSettings() {
        guard let url = SettingsTransferPanels.chooseImportURL() else { return }
        do {
            ...
            guard SettingsTransferPanels.confirm(
                title: "Import Settings?",
                message: importPreviewMessage(imported: imported, resolvedImport: resolvedImport),
                confirmTitle: "Apply"
            ) else { return }
    ...
    private func showImportError(_ error: Error) {
        SettingsTransferPanels.showWarning(title: "Import Failed", message: importErrorMessage(error))
    }
    ...
    private func exportSettings() {
        ...
        guard let url = SettingsTransferPanels.chooseExportURL(defaultName: "lockout-settings.json") else { return }
        do {
    ...
    private func roleLabel(_ role: UserRole) -> String {
        ...
        case .itManaged: return "IT Managed"
    ...
    private func enforcementLabel(_ mode: BreakEnforcementMode) -> String {
        ...
        case .softLock: return "Soft Lock"
        case .hardLock: return "Hard Lock"
        }
    }
